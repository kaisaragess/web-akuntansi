...
exports.GET_journals_Req = void 0;
...
], GET_journals_Req_Query.prototype, "limit", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)((param) => ((param === null || param === void 0 ? void 0 : param.value) === null || (param === null || param === void 0 ? void 0 : param.value) === undefined || (param === null || param === void 0 ? void 0 : param.value) === '') ? null : parseFloat(param.value)),
...
__decorate([
    ...
    __metadata("design:type", String)
], GET_journals_Req_Headers.prototype, "authorization", void 0);
class GET_journals_Req {
}
exports.GET_journals_Req = GET_journals_Req;
__decorate([
    (0, class_transformer_1.Type)(() => GET_journals_Req_Query),
    __metadata("design:type", GET_journals_Req_Query)
], GET_journals_Req.prototype, "query", void 0);
__decorate([
    (0, class_transformer_1.Type)(() => GET_journals_Req_Headers),
    __metadata("design:type", GET_journals_Req_Headers)
], GET_journals_Req.prototype, "headers", void 0);
