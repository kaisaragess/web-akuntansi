...
__decorate([
    ...
    (0, class_transformer_1.Transform)((param) => ((param === null || param === void 0 ? void 0 : param.value) === null || (param === null || param === void 0 ? void 0 : param.value) === undefined || (param === null || param === void 0 ? void 0 : param.value) === '') ? null : parseFloat(param.value)),
    (0, class_validator_1.IsNumber)({}, { message: 'debit must be a number (decimal)' }),
    __metadata("design:type", Number)
], Entry.prototype, "debit", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'credit cannot be empty' }),
    (0, class_transformer_1.Transform)((param) => ((param === null || param === void 0 ? void 0 : param.value) === null || (param === null || param === void 0 ? void 0 : param.value) === undefined || (param === null || param === void 0 ? void 0 : param.value) === '') ? null : parseFloat(param.value)),
    (0, class_validator_1.IsNumber)({}, { message: 'credit must be a number (decimal)' }),
    __metadata("design:type", Number)
], Entry.prototype, "credit", void 0);
